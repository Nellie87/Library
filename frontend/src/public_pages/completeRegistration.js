...
class completeRegistration extends React.Component {
    ...
    componentDidMount() {
        if (this.props.location && this.props.location.state) {
            const { user_info, authState } = this.props.location.state;
            // Do something with the data
            //console.log('User Info at profile:', user_info);
            //console.log('Auth State at profile:', authState);



            const[year, month, date] = user_info.dob.split('-');

            this.setState({

                        first_name: user_info.first_name,
                        middle_name: user_info.last_name,
                        last_name: user_info.surname,
                        email: user_info.email,
                        gender:user_info.gender,
                        identification_number: user_info.id_number,
                        year: year,
                        month:month,
                        date:date,
                        //dob: user_info.dob,
                        mobile: user_info.mobile_number,
                        password:this.props.authState,
                        cpassword:this.props.authState,
    ...
    handleSubmit(event) {
        ...
        funcObj.commonFetchApiCall(postBodyData, endPoint, 'POST', true).then(data => {
            if (data.code == 200) {
                funcObj.custom_alert_message(data.data.message,'success','home')
                                        ...
                                        this.state.authentication == true ?
                                            ...
                                            <form id="loginFrm" method="POST" >
                                                ...
                                                <div className="form-group w-33">
                                                    <input type="text" className={`input-field form-control ${this.state.input_errors["first_name"]} `} placeholder="First name" name="first_name" id="first_name" onChange={this.handleChange} defaultValue={this.state.first_name} onBlur={(e) => this.checkUserType(e)}  readOnly />
                                                    <span className="error_text">{this.state.errors["first_name"]}</span>
                                                </div>
                                                <div className="form-group w-33">
                                                    <input type="text" className={`input-field form-control  `} placeholder="Middle name" name="middle_name" onChange={this.handleChange} defaultValue={this.state.middle_name}  readOnly />

                                                </div>
                                                <div className="form-group w-33">
                                                    <input type="text" className={`input-field form-control  `} placeholder="Last name" name="last_name" id="last_name" onChange={this.handleChange} defaultValue={this.state.last_name}  readOnly/>
                                                    <span className="error_text"></span>
                                                </div>
                                                <div className="form-group w-33 w10mob">
                                                    <div className='w-50 mob-w'>
                                                        <select name="year" id="year" className={`input-field form-control  ${this.state.input_errors["year"]} `} onChange={this.handleChange}  value={this.state.year}  >
                                                            <option>Year of Birth</option>
                                                            {funcObj.year(this.state.start_year,this.state.end_year)}
                                                        </select>
                                                    </div>
                                                    <div className='w-25 mob-w'>
                                                        <select name="month" className={`input-field form-control  `} onChange={this.handleChange}  value={this.state.month}>
                                                            <option>Month</option>
                                                            {funcObj.month()}
                                                        </select>
                                                    </div>
                                                    <div className='w-25 mob-w'>
                                                        <select name="date" className={`input-field form-control  `} onChange={this.handleChange} onBlur={(e) => this.checkDobValidation(e)} value={this.state.date}>
                                                            <option>Date</option>
                                                            {funcObj.date()}
                                                        </select>
                                                    </div>
                                                ...
                                                <div className="form-group w-33">
                                                    <input type="text" className={`input-field form-control  ${this.state.input_errors["email"]}  `} placeholder="Email address" name="email" id="email" onChange={this.handleChange}  onBlur={(e) =>  this.validateEmail(e)} defaultValue={this.state.email}  readOnly />
                                                    <span className="error_text">{this.state.errors["email"]}</span>
                                                </div>


                                                <div className="form-group w-33">
                                                    <input type="text" className={`input-field form-control ${this.state.input_errors["mobile"]} `} placeholder="Mobile/telephone number" name="mobile" id="mobile" onChange={this.handleChange}  defaultValue={this.state.mobile}  readOnly />
                                                ...
                                                <div className="form-group w-33 ww-50">
                                                    <input type="text" className={`input-field form-control  ${this.state.input_errors["identification_number"]}  `} placeholder="Identification Number" name="identification_number" id="identification_number" onChange={this.handleChange} defaultValue={this.state.identification_number} onBlur={(e) =>  this.validateIdentification(e)}  readOnly />
                                                ...
                                                <div className="form-group">
                                                    <button onClick={(e) =>this.handleSubmit(e)} data-sitekey="6Lc1jIUbAAAAAEOuOTPyRMVHSLQL50rGxRGU295F" data-callback='onSubmit' type="button" className=" g-recaptcha btn signinBtn">Complete Profile</button>
                                                </div>
                                                {/*<div className="light-text">*/}
