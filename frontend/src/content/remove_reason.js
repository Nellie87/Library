...
class removeReason extends React.Component {
                        ...
                        <div className="breadcrumbs py-1">
                          ...
                          <React.Fragment>
                            ...
                            <div className="clearfix top-head mb-2">
                                <h3 className="dashboard-title title-margin my-2 float-left">Delete Reason for - <b>{this.state.content_detail.title}</b></h3>
                            </div>
                            <div className="row">
...
export default withRouter(removeReason);
