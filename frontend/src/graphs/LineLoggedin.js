...
class LineLoggedin extends React.Component {
  constructor(data) {
    super();
    this.state = {
      active_graph: 'week',
  ...
  generateGraph(active_graph) {
    ...
    let graph_labels = (this.props.data)?this.props.data.user_loggedin.labels:[];
    let user_data = (this.props.data)?this.props.data.user_loggedin.new_user:[];
    let subscription_data = (this.props.data)?this.props.data.user_loggedin.subscribe_user:[];
    // let graphdata = {
