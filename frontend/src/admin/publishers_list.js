...
export default  class PublishersList extends React.Component {
                ...
                <div className="card mt-4">
                    <div className="dashboard-box">
                        <div className="clearfix top-head mb-4">
                            <h3 class="dashboard-title title-margin my-2 float-left">Content providers</h3>
                            <div className="float-right">
                                <div className="add-btn-wrap">
                                    <span className="add-icon">+</span>
                                    <Link to="/add-publishers" className="btn darkBtn">Add New</Link>
                                </div>
                            </div>
                        </div>
                        <div className="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"> Class <i className="sort-icon"></i></th>
                                    <th scope="col"> Category <i className="sort-icon"></i> </th>
