...
export default  class SubscriptionsReport extends React.Component {
                    ...
                    <div className="card mt-4">
                        <div className="dashboard-box">
                            <div className="clearfix top-head mb-2">
                                <h3 className="dashboard-title title-margin my-2 float-left">Filter Subscriptions</h3>
                            </div>
                            <div className="row">
                        ...
                        <div className="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">  Activation Date <i className="sort-icon"></i> </th>       
                                    <th scope="col">  Expiry Date <i className="sort-icon"></i> </th>   
