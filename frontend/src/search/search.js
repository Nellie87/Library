...

                    {
                        ...
                        <div className="banner text-center">
                                            <div className="container">
                                                <span className="page_title"> Library</span>
                                            </div>
                                        </div>
                        :
                        null
                        ...
                        <div className="search_wrap clearfix " style={{'marginTop':margin}}>
                            ...
                            <div className="right_bar float-left p-4">
                                ...
                                {elements.map((value, index) => {
                                    let link = detail_page;
                                    if(  AUTH_USER != null ){
                                        link =  detail_page+`?book_type=`+value.book_type;
                                    }
                                        return (
                                    <Link to={link} className="col-xl-3 col-lg-4 col-md-6 mb-3 mb-lg-5">
