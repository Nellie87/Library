...
export default class Search extends React.Component {
    ...
    searchMiddleContent(){
        let margin = '-50px';
        let detail_page = 'audio-bookdetail';
        if(  AUTH_USER != null ){
             margin = '0';
        ...
        const elements = [
            {
              "id": "1",
              "picture": "/images/books/audio/audio1.jpg",
              "title": "Harry Potter Deathly Hallows",
              "subtitle": "J.K. Rowlings",
            },
            {
                "id": "2",
                "picture": "/images/books/audio/audio2.jpg",
                "title": "Harry Potter Curesed Child",
                "subtitle": "J.K. Rowlings",
            },
            {
                "id": "3",
                "picture": "/images/books/audio/audio3.jpg",
                "title": "Chanakya Neeti",
                "subtitle": "Rishi Upadhyay",
            },
            {
                "id": "4",
                "picture": "/images/books/audio/4.jpg",
                "title": "Godaan (Hindi Edition)",
                "subtitle": "Sameer Goswami",
            },
            {
                "id": "5",
                "picture": "/images/books/audio/5.jpg",
                "title": " Autobiography of a Yogi",
                "subtitle": "Ben Kingsley",
            },
            {
                "id": "6",
                "picture": "/images/books/audio/6.jpg",
                "title": "Ulrike Bellemann",
                "subtitle": "fernandezstanton@xeronk.com",
            },
            {
                "id": "7",
                "picture": "/images/books/audio/7.jpg",
                "title": "Sita: An Illustrated Retelling of the Ramayana",
                "subtitle": "Suyash Mohan",
            },
            {
                "id": "8",
                "picture": "/images/books/audio/8.jpg",
                "title": "7 Secrets of the Goddess",
                "subtitle": "Sagar Arya",
            },
            {
                "id": "9",
                "picture": "/images/books/Image1.png",
                "title": "The House of Hunger",
                "subtitle": "Dambudzo Marechera",
            },
            {
                "id": "10",
                "picture": "/images/books/Image2.png",
                "title": "Thirteen Mont",
                "subtitle": "Rania Mamoun",
            },
            {
                "id": "11",
                "picture": "/images/books/Image3.png",
                "title": "Hunger Eats",
                "subtitle": "Nkosinathi Sithole",
            },
            {
                "id": "12",
                "picture": "/images/books/Image4.png",
                "title": "Daughters wh",
                "subtitle": "Yejide Kilanko",
            }
        ]
        return(
            <React.Fragment>
...

                    {
                        ...
                        <div className="banner text-center">
                                            <div className="container">
                                                <span className="page_title"> Audio Books</span>
                                            </div>
                                        </div>
                        :
                        null
                                        ...
                                        <div className="book-wrap-card">
                                            <div className="card-book">
                                                <div className="img-wrap">
                                                    <img src={funcObj.assets_path(value.picture)} alt="books" />
