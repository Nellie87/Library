...
var DEFAULT_SCALE_VALUE = custom_default_scale_value;
...
function getPDFFileNameFromURL(url) {
  var defaultFilename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : global_pdf_file_name;
  ...
  function PDFDocumentProperties(_ref, overlayManager, eventBus) {
    ...
    if (eventBus) {
      eventBus.on('pagechanging', function (evt) {
          saveCurrentPageNumber(evt.pageNumber,PDFViewerApplication.pdfDocument.numPages);
...
function (_BaseViewer) {
  ...
  _createClass(PDFViewer, [{
    ...
    value: function _updateHelper(visiblePages) {
      ...
      if(global_read_duration != 0){
         currentId = global_read_duration
      }
...
;
var DISABLE_CREATE_OBJECT_URL = false;
