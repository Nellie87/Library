<?php $pdffile = $_GET['file_name']; 
?>
<script>
var global_pdf_file_name = '<?php echo $pdffile;?>';    
</script>
<html dir="ltr" mozdisallowselectionprint>
  <head>
    <link rel="stylesheet" href="third_party_resources/viewer.css">


<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="locale/locale.properties">
<script src="third_party_resources/build/pdf.js"></script>
    <script src="third_party_resources/viewer.js"></script>
    <script src="third_party_resources/jquery-3.4.1.min.js"></script>
    <script src="third_party_resources/turn.min.js"></script>
    <link rel="stylesheet" href="third_party_resources/pdf-turn/pdf-turn.css">
    <script src="third_party_resources/pdf-turn/pdf-turn.js"></script>
  </head>
